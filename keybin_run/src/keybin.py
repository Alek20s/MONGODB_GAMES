    ...
    for page in range(1, 31):
        ...
        try:  # Fetch products for the current page
            response = requests.get(
                f"https://api.keybin.net/v1/products?embed_listings=true&take=50&page={page}", headers=headers, proxies=proxies
            )
            ...
            for product in products:
                try:
                    ...
                    listings = [
                        ...
                        if listing["isActive"] and listing["activeStock"] > 0 and listing["price"]["minOrderQty"] is None
                    ]
